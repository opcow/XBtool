...
#include "stdafx.h"
#include <atlstr.h>
#include "CX24977Patcher.h"

void CX24977Patcher::InitPatches()
{
	static int XGlowOffset[] =			{ 0x0005C78B, 0x0005C795, 0x0005C79E };
	static int AniGlowOffset =			0x0005A67B;
	static int XWallOffset[] =			{ 0x0005C7A8, 0x0005C7B1, 0x0005C7BB };
	static int XLipHighlightsOffset =	0x0005BDF9;
	static int XLipOffset =				0x0005BDFE;
	static int XBOXTextOffset =			0x0005C94B;
	static int DefXBEOffset =			0x2a37;

	static AnimPatch xAnimPatch =
	{
		{ 0x000571E8, 0x0005794F, 0x00058049, 0x00058071 },
		{ { 0x90, 0x90 }, { 0x74, 0x09 } },
		{ { 0x90, 0x90 }, { 0x74, 0x09 } },
	...
	static DashPatch xDashPatch =
	{
		...
		{ 0x53, 0x68, 0xF8, 0x2B, 0x01, 0x80, 0xE8, 0x09, 0x25, 0xFF, 0xFF, 0x59, 0x33, 0xDB, 0x53, 0x6A, 0x01, 0x68, 0x44, 0x2A, 0x01, 0x80 },
		3,
		{ 14, 10, 14},
		0x2984
	};
	...
	static unsigned char xID_Digest[] = { 0xb7, 0xa7, 0x08, 0xae, 0xda, 0x3c, 0x45, 0x3e, 0x25, 0x29, 0xb9, 0xba, 0x89, 0xa8, 0xc3, 0x4d };
	...
	mNativeSizeOfKernel		= 0xA9300;
	mpKernelName			= "X2 4977";
...
void CX24977Patcher::GetSupportedOptions(BIOS_Supported_Options &SupOpts)
{
	SupOpts = mSupOpts;
}
